...
namespace Prime31
{
	public class EtceteraAndroidEventListener : MonoBehaviour
	{
		private void OnEnable()
		{
			...
			EtceteraAndroidManager.webViewDidLoadURLEvent += webViewDidLoadURLEvent;
		}
		...
		{
			UnityEngine.Debug.Log("onRequestPermissionsResultEvent");
			Utils.logObject(result);
		}

		private void webViewDidLoadURLEvent(string url)
		{
			UnityEngine.Debug.LogFormat("webViewDidLoadURLEvent: {0}", url);
		}
	}
}
