...
namespace AnchorLinkTransportSharp.Src.Transports.Canvas
{
    public class UnityCanvasTransport : UnityTransport
    {
        ...
        [SerializeField] private Text CountdownTextGUI;
        ...
        private void SwitchToLightTheme()
        {
            ...
            foreach (var _childText in gameObject.GetComponentsInChildren<Text>(true))
            {
            ...
            foreach (var _childButton in gameObject.GetComponentsInChildren<Button>(true))
            {
                ...
                {
                    if (_childButton.targetGraphic.GetType() == typeof(Text) && _childButton.GetComponent<Image>())
                    ...
                    else if (_childButton.targetGraphic.GetType() == typeof(Image))
                    {
                        ...
                        _childButton.targetGraphic = _childButton.GetComponentInChildren<Text>(true);
                    }
                ...
                else
                {
                    if (!_childButton.name.Contains("QR") && _childButton.GetComponent<Image>())
                    {
                        ...
                        _childButton.GetComponentInChildren<Text>().color = Color.black;
