...
namespace AnchorLinkTransportSharp.Examples.Canvas
{
    public class CanvasExample : MonoBehaviour
    {
        ...
        [Header("Input fields")]
        [SerializeField] private InputField _fromAccountField;
        [SerializeField] private InputField _toAccountField;
        [SerializeField] private InputField _tokenAmountField;
        [SerializeField] private InputField _memoField;
        ...
        public async void TryTransferTokens(GameObject TransferDetailsPanel)
        {
            ...
            foreach (var _inputField in TransferDetailsPanel.GetComponentsInChildren<InputField>())
            {
        ...
        {
            if (_canvasEventSystem.currentSelectedGameObject?.GetComponent<InputField>() != null)
                _canvasEventSystem.currentSelectedGameObject.GetComponent<InputField>().text = pastedText;
        }
    }
}
