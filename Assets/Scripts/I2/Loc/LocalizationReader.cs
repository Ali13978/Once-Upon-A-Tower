...
namespace I2.Loc
{
	public class LocalizationReader
	{
		public static Dictionary<string, string> ReadTextAsset(TextAsset asset)
		{
			...
			{
				string value;
				string key, valueString, temp1, temp2, temp3;
				if (TextAsset_ReadLine(line, out key, out valueString, out temp1, out temp2, out temp3) && !string.IsNullOrEmpty(key) && !string.IsNullOrEmpty(valueString))
