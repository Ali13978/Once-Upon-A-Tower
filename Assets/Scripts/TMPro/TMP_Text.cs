...
namespace TMPro
{
	public class TMP_Text : MaskableGraphic
	{
		...
		private void Localize()
		{
			...
			if ((bool)component && component.LastLocalizedLanguage != LocalizationManager.CurrentLanguage)
			{
		...
		public void SetSceneText(string s)
		{
			m_sceneText = s;
		}
		...
		protected bool ValidateHtmlTag(int[] chars, int startIndex, out int endIndex)
		{
			...
			case 41311:
			{
				...
				if (!MaterialReferenceManager.TryGetFontAsset(valueHashCode4, out TMP_FontAsset fontAsset))
				{
